package br.com.aws.rekognition.service;
...
import br.com.aws.rekognition.handler.MultipleFacesException;
import br.com.aws.rekognition.handler.NotHumanFaceException;
import br.com.aws.rekognition.handler.NotRegisteredFaceException;
...
public class RekognitionService {
    ...
    @Autowired
    public RekognitionService(AmazonS3 s3client,
    ...
    public RekognitionResponse buscar(MultipartFile foto) throws Exception {
        if (!isFace(foto.getBytes())) {
            throw new NotHumanFaceException();
        }
    ...
    public RekognitionResponse comparar(MultipartFile foto, String id) throws Exception {
        if (!isFace(foto.getBytes())) {
    ...
    public RekognitionResponse compararFotos(MultipartFile foto1, MultipartFile foto2) throws Exception {
